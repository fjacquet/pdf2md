...
// LayoutConfig holds configurable thresholds for layout analysis.
...
func ConfigForAcademicPapers() *LayoutConfig {
	cfg := DefaultConfig()
...
func ConfigForTechnicalDocs() *LayoutConfig {
	cfg := DefaultConfig()
...
func ConfigForScannedDocuments() *LayoutConfig {
	cfg := DefaultConfig()
